...
/**
 * The OperationalPhasesProcess describes the behaviour of malware over time
 * in terms of operational phases, each of which may have different processes
...
public interface OperationalPhasesProcess extends Runnable {
